...
HD_PWD='/home/ubuntu/pratica-de-eletronica-digital-1/unidade_logica_programavel/unidade_logica_programavel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ULA_PED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ULA_PED.tcl -notrace
