...
HD_PWD='/home/ubuntu/pratica-de-eletronica-digital-1/unidade_logica_programavel/unidade_logica_programavel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ULA_PED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ULA_PED.tcl
