...
HD_PWD='C:/Users/Alunos/Desktop/Vinícius_Cantuária/Vinícius_Cantuária.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soma3bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soma3bits.tcl
